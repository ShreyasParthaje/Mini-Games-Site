...
export const events: EventData[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Players are not allowed communicate with each other',
      'Trading constraints:',
      'A maximum of 10 trades are allowed within the team; however, the team may choose to reveal their cards and finalize scoring earlier, after which no further trades will be permitted—even if the trade limit has not been reached.',
      'Each team may exchange any one card currently in their possession with a volunteer for another card.',
      'Maximum of 5 trades allowed between volunteer and a team member',
      'Must trade one card for one card',
      'After /trades expire, everyone reveals their hands and volunteers tabulate the scores',
    ],
    judgingCriteria: [
      "Team's combined score is added to the total score",
    ],
  },
  {
    id: 3,
