...
export const events: EventData[] = [
  ...
  },
  {
    ...
    teamSize: '3-5',
    rules: [
      'One player is the drawer, rest are guessers',
      'Drawer sees a word (e.g., "elephant", "bicycle", "house")',
      ...
      'Drawer has 60 seconds per word',
      'Team shouts guesses continuously',
      'Rotate drawer after each word',
      'Play 10 rounds total',
    ],
    judgingCriteria: [
      'Team correctly guesses 6 or more out of 10 words',
    ],
  },
  {
    id: 4,
