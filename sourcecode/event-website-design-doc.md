...
### Primary Colors
```css
--primary-600: #0AEEFF      /* Main brand color (buttons, accents) - Cyan */
--primary-700: #00E5FF      /* Hover states - Lighter cyan */
--primary-800: #0A7EEF      /* Active states - Darker cyan */
```
...
box-shadow: 0 4px 8px rgba(10, 238, 255, 0.35)
```
...
- Gradient colors: 
  - Start: #00FFFF (Bright cyan - lighter shade)
  - End: #0A7EEF (Darker cyan - darker shade)
- Creates a vibrant cyan gradient effect suited to the dark theme

**CSS Implementation:**
```css
.hero__title {
  background: linear-gradient(135deg, #00FFFF, #0A7EEF);
...
If animation is not desired, use the static version without animation keyframes. The gradient will remain fixed at the 135deg angle with smooth cyan transitions suited to the dark theme.
